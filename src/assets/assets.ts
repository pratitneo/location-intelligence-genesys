import ThreeDMap from './3d-map.svg'
import Charts from './charts.svg'
import Dataset from './dataset.svg'
import DrawOnMap from './draw-on-map.svg'
import EditPen from './edit-pen.png'
import GeoTool from './geo-analysis-tool.svg'
import Legend from './legend.svg'
import LoginLogo from './login-logo.svg'
import MapSwitcher from './maps.svg'
import PasswordEye from './password-eye.svg'
