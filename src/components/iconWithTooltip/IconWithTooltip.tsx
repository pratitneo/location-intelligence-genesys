...
const IconWithTooltip: React.FC<IconWithTooltipType> = ({ iconTooltipId, icon, tooltipText, position = "right", customCls = "", getActionFn }) => {
  return (
    <div id={iconTooltipId} className={` ${styles[`lip-tooltip__${customCls}`]} ${styles['lip-tooltip__wrap']}`} onClick={getActionFn}>
