...
const RetailSpectra = ({ hexData }: { hexData?: any }) => {
    ...
    const COLORS = ['#6FFFE9', '#F5B942', '#FB7185', '#6FD195'];
    const data = [
    ...
    return (
        <div>
            <DropownDesc desc='Surrounded by brands like <brand> and <brand>, and <count> retail mix in fashion, the area balances competition with high shopper density' />
