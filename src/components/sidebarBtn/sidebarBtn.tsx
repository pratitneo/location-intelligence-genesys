...
const SidebarBtn = ({ sidebarBtnId, sideBtnIcon, sideBtnText, sideBarText, getActionFn }: SideBtnType) => {
    return (
        <div id={sidebarBtnId} className={`${sideBtnCss['lip-sidebtn__item']}`} onClick={getActionFn}>
